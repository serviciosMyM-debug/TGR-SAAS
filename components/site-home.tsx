    ...
    <>
      ...
      <Section id="nosotros">
        <div className="sectionHeading">
          ...
          <p>
            Somos una empresa especializada en servicios eléctricos, comprometida con la calidad,
            la seguridad y la eficiencia en cada proyecto que realizamos.
          </p>
        </div>
      </Section>
      ...
      <Section id="servicios">
        <div className="sectionHeading">
          ...
          <h2>Soluciones eléctricas pensadas para obras, reformas y proyectos con criterio profesional.</h2>
        </div>
      ...
      <Section id="obras">
        <div className="sectionHeading">
          ...
          <h2>Galería institucional de obras realizadas.</h2>
        </div>
      ...
      <Section className="contactSection" id="contacto">
        <div className="contactCard">
          <div>
            ...
            <p>
              Contactanos para recibir asesoramiento y un presupuesto adaptado a tu proyecto.
            </p>
          </div>
...
export { SiteHomeComponent as SiteHome };
